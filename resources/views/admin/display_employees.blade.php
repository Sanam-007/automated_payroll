...
<div class="container" style="background-color:#44e0e680" >
        <div class="row" >
            <h2 class="mt-3"  style="margin-left:450px" >All Employee Information</h2>
  ...
  <button type="button" class="btn btn-danger"> <a href ="{{URL::to('employee-delete/'.$employee->id)}}"><b>Delete</b></button></td>
      ...
      <button type="button" class="btn btn-light"> <a href ="{{URL::to('generate-pdf2')}}"><b> pdf generate</b></button></td>
            </div>
        </div>
    </div>
