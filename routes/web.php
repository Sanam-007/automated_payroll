...
Route::middleware(['IsLoggedIn','IsEmployee'])->group(function(){
    ...
    //Route::get('/pass-change',[EmployeeController::class,'updatePassword']);
    

    Route::get('/upload-image',[EmployeeController::class,'uploadImage']);
    Route::post('/store-image',[EmployeeController::class,'storeImage']);

    Route::get('/emp-pass-change',[EmployeeController::class,'updatePassword']);
    Route::post('/emp-update-pass',[EmployeeController::class,'updatepass']);

    Route::get('/employee-edit',[EmployeeController::class,'edemployee']);
    Route::post('/employee-update',[EmployeeController::class,'upEmloyee']);
    Route::get('/show-salary',[EmployeeController::class,'showSalary']);
...
Route::middleware(['IsLoggedIn','IsAdmin'])->group(function(){
    ...
    Route::get('pass-change',[AdminController::class,'pass']);
    Route::get('update-pass',[AdminController::class,'updatepass']);
